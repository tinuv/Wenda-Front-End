<template>
  <Card style="width: 1000px">
    <div slot="title">{{answers.length}}&nbsp;&nbsp;条回答</div>
    <div>
      <div v-for="answer in answers">
        ...
        <div style="margin-top: 10px;">{{answer.pros}} 人赞同了回答</div>
        <div style="margin-top: 10px" v-html="answer.htmlContent" class="markdown-body"></div>
        <div style="margin-top: 20px">编辑于2019</div>
        <div style="margin-top: 10px">
          <Button type="primary">赞同回答</Button>
        </div>
    ...
    export default {
        ...
        methods: {
            getAnswerByIssue() {
                ...
                this.$axios.get("/wenda/api/answer/issue/" + part, {
                    headers: {
                        'Authorization': jwt
                    }
                }).then(response => {
                    if (response['data']['success'] === true) {
                        ...
                        for (let i = 0; i < this.answers.length; i++) {
                            this.answers[i].htmlContent = trimHtml(this.answers[i].htmlContent, {more: true})['html']
                        }
                    } else {
